...
describe_check_groups <- function() {
  ...
  if (!identical(names(d), all_check_groups())) {
    cli::cli_abort("Group names in 'describe_check_groups' differ from 'all_check_groups'.")
  }
  d
}
